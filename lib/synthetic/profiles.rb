...
module Synthetic
  ...
  # допуска по распределению в п.п.: чем патологичнее профиль, тем менее
  # предсказуема доля шума, тем шире коридор.
  #
  ...
  # единица — полное, все wide-провайдеры принимают любую сумму уровня. Это
  # ручка «сколько у стратегии реального выбора»: при делителе 2 и высокой
