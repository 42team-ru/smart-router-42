...
module Routing
  module Constraints
    ...
    #
    # Дальше по коду: Routing::Details.bank_not_allowed и .bank_excluded — тексты
    # причин для каждого из двух режимов; Routing::Achievable — как ограничения
    # по банкам превращаются в достижимую долю.
