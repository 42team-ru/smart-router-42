...
# фейковых слоях (spec/support/fake_layer.rb), пока настоящих слоёв (X-1/X-2/X-3)
# ещё нет. Не тестирует прод-код — тестирует нашу тестовую обвязку: если этот
# файл когда-нибудь начнёт падать сам по себе, значит контракт сломан, а не
# слои Вовы.
